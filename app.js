...
let trackList = [
    {
        ...
        path: "./music/The Black Skirts - EVERYTHING.mp3",
    },
    {
        name: "A Piece of You",
        artist: "Nathaniel Constantin",
        path: "./music/Nathaniel Constantin - A Piece of You (Official Lyric Video).mp3",
    },
    {
        name: "Say Yes To Heaven",
        artist: "Lana Del Rey",
        path: "./music/Lana Del Rey - Say Yes To Heaven (Official Audio).mp3",
    },
];
